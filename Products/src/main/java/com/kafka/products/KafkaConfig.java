...
import com.kafka.products.service.ProductCreatedEvent;
...
public class KafkaConfig {
    ...
    private Integer requestPerConnection;
    ...
    Map<String, Object> producerConfigs() {
        ...
        configs.put(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, requestPerConnection);
    ...
    /**
     * Create new topic if not present in kafka cluster
     */
    @Bean
